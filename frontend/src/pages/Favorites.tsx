...
const Favorites = () => {
    ...
    const fetchFavorites = async (page: number = 1) => {
        setLoading(true);
        try {
            const response = await axios.get<FavoritesResponse>(`/api/favorites?page=${page}`);
    ...
    return (
        <div className="w-full bg-gray-900 max-h-[90vh] px-4 md:px-6 py-8 overflow-y-auto scrollbar-hide">
            <div className="max-w-4xl mx-auto">
                <div className="flex justify-between items-center mb-8">
                    ...
                    <div className="flex rounded-lg overflow-hidden">
                        <Link to="/search" className="px-4 py-2 text-white bg-gray-800 hover:bg-gray-700 transition duration-200">
                            Search
                        </Link>
                        <Link to="/favorites" className="px-4 py-2 text-white bg-yellow-500 font-medium">
                            Favorites
                        </Link>
                    </div>
                </div>
